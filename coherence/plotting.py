...
def coherence_freqwise(coh, group_master, group_fig=[], group_plot=[], plot_shuffled=False, plot_std=True, n_plots_per_page=6,
    ...
    # Establishes keys for groups used in generating labels for data
    coh_data_keys = ['freqs', 'coh', 'coh_std', 'fbands', 'fbands_avg', 'fbands_avg_std', 'fbands_max',
                     'fbands_max_std', 'fbands_fmax', 'fbands_fmax_std'] # keys containing data that do not represent...
...
def coherence_bandwise(coh, group_master, group_fig=[], group_plot=[], plot_shuffled=False, plot_std=True, n_plots_per_page=6,
